...
def analyze_ks(rootfile, mva):
    mva_name = rootfile.split('/')[-1].replace('.root', '')    
    dir_name = rootfile.split('/')[-1].replace('.root', '')    
    mva_name = mva

    print('[analyze] looking for trees in: '+dir_name)
    test_tree_name = dir_name+'/TestTree'
    train_tree_name = dir_name+'/TrainTree'
...
if __name__ == '__main__':
    print('PyKeras', analyze_ks('test_dir/test.root', 'PyKeras'))
    print('PyKeras_v2', analyze_ks('test_dir/test.root', 'PyKeras_v2'))
    print('PyKeras_v3', analyze_ks('test_dir/test.root', 'PyKeras_v3'))
    print('GradBDT', analyze_ks('test_dir/test.root', 'GradBDT'))
    print('AdaBDT', analyze_ks('test_dir/test.root', 'AdaBDT'))
